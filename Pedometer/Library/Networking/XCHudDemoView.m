...
#import "XCHudDemoView.h"
#import "MBProgressHUD.h"
#import <QuartzCore/QuartzCore.h>

@interface XCExample : NSObject
...
@interface XCHudDemoView () <NSURLSessionDelegate>

@property (nonatomic, strong) NSArray<NSArray<XCExample *> *> *examples;
...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.examples =
    @[@[[XCExample exampleWithTitle:@"Indeterminate mode" selector:@selector(indeterminateExample)],
        [XCExample exampleWithTitle:@"With label" selector:@selector(labelExample)],
        [XCExample exampleWithTitle:@"With details label" selector:@selector(detailsLabelExample)]],
      @[[XCExample exampleWithTitle:@"Determinate mode" selector:@selector(determinateExample)],
        [XCExample exampleWithTitle:@"Annular determinate mode" selector:@selector(annularDeterminateExample)],
        [XCExample exampleWithTitle:@"Bar determinate mode" selector:@selector(barDeterminateExample)]],
      @[[XCExample exampleWithTitle:@"Text only" selector:@selector(textExample)],
        [XCExample exampleWithTitle:@"Custom view" selector:@selector(customViewExample)],
        [XCExample exampleWithTitle:@"With action button" selector:@selector(cancelationExample)],
        [XCExample exampleWithTitle:@"Mode switching" selector:@selector(modeSwitchingExample)]],
      @[[XCExample exampleWithTitle:@"On window" selector:@selector(windowExample)],
        [XCExample exampleWithTitle:@"NSURLSession" selector:@selector(networkingExample)],
        [XCExample exampleWithTitle:@"Determinate with NSProgress" selector:@selector(determinateNSProgressExample)],
        [XCExample exampleWithTitle:@"Dim background" selector:@selector(dimBackgroundExample)],
        [XCExample exampleWithTitle:@"Colored" selector:@selector(colorExample)]]
      ];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    XCExample *example = self.examples[indexPath.section][indexPath.row];
